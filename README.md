...
Image classification is one of the computer vision tasks that serves as [the foundation for solving different computer vision problems](https://www.altexsoft.com/blog/image-recognition-neural-networks-use-cases/) such as object detection and object semantic segmentation.

### Why does this repository help?
...
- [Distributed data_parallel training (Pytorch Distributed Data Parallel)](https://github.com/sdamadi/image-classification/blob/main/README/distributed_data_parallel_training.me)
